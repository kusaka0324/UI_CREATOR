...
def Controller():
    if request.method == "GET":
        return render_template("controller/controller" + request.args.get("controller") + ".html")
    if request.method == "POST":
        data = request.json
        with open("controller/controller" + data["controller"] + ".html", "wb") as file:
            file.write(data["html"])
        with open("controller/controller" + data["controller"] + ".css", "wb") as file:
            file.write(data["css"])
